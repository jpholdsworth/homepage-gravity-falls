...
## ⚡ Usage
1. Open the web application in your browser (localhost during dev or deployed site)
2. Change the screen size or orientation to see how responsiveness to any devices.
